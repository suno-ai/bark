...
Bark is a transformer-based text-to-audio model created by [Suno](https://suno.ai). Bark can generate highly realistic, multilingual speech as well as other audio - including music, background noise and simple sound effects. The model can also generate nonverbal communications like laughing, sighing and crying. To support the research community, we are providing access to pretrained model checkpoints, which are ready for inference and available for commercial use.
...
**2023.05.01**
- ©️ Bark is now licensed under the MIT License. It's now available for commercial use! If you are interested in a hosted API, please fill out our [waitlist](https://3os84zs17th.typeform.com/suno-studio). 
