...
def _load_model(ckpt_path, device, use_small=False, model_type="text"):
    ...
    checkpoint = torch.load(ckpt_path, map_location=device, weights_only=False) # Fix AttributeError by loading full checkpoint (weights_only=False) instead of weights-only
    # this is a hack
